...
public class formPassword extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("(Atleast 8 characters long)");

        enterButton.setText("Generate password");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(enterButton, javax.swing.GroupLayout.PREFERRED_SIZE, 244, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(73, 73, 73))
    ...
    private void enterButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_enterButtonActionPerformed
        ...
        random= (int)Math.ceil(Math.random()*100); //this creates a random number between 1 and 100
               
        if(password.length() >= 8) { //if the psasword is greater or equal to 8, the program prints out the password and username
        outputLabel.setText ("Username: "+ (username.toLowerCase()) + " Password: " + password + random);
